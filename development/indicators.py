...
class Indicators():
    ...
    # New Indicator
    def smma(self, period: int, column_name: str = 'smma') -> pd.DataFrame:
    ...
    def supertrend(self, atr_length: int = 10, multiplier : int = 3, column_name: str ='supertrend') -> pd.DataFrame:
        ...
        self._frame[column_name] = supertrend_list

        self._frame[column_name] = np.where(self._frame[column_name] == True, 1.0, -1.0)
    ...
    # New Indicator
    def trading_zone(self, start_time: str = '00:00:00', end_time: str = '23:59:59', column_name: str = 'trading_zone') -> pd.DataFrame:
        """Only able to trade within the timezone.
        ...
        self._current_indicators[column_name] = {}
        self._current_indicators[column_name]['args'] = locals_data
        self._current_indicators[column_name]['func'] = self.trading_zone
